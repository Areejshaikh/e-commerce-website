    ...
    return (
        <div>
            ...
            <div className='mx-12  md:flex'>
                <div className=' mb-16 w-28  h-28 rounded-full border mx-auto border-sky-500 bg-slate-100'>
                    <Image
                        src={image1}
                        alt="product"
                        width={200}
                ...
                <div className='mb-16 w-28 h-28 rounded-full border mx-auto bg-slate-100'>
                    <Image
                        src={image2}
                        alt="product"
                        width={200}
